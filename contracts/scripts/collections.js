...
(async () => {
  ...
  const details = [
    ...
    //     amount: 33,
    //     prices: ["242000000000000000000", "125000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [3, 17, 28],
    //     workers: [
    //       {
    ...
    //     amount: 50,
    //     prices: ["120000000000000000000", "76000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [5, 12, 30],
    //     workers: [
    //       {
    ...
    //     amount: 22,
    //     prices: ["310000000000000000000", "142000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [7, 29],
    //     workers: [
    //       {
    ...
    //     amount: 43,
    //     prices: ["230000000000000000000", "113000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [4, 21, 35, 9],
    //     workers: [
    //       {
    ...
    //     amount: 50,
    //     prices: ["478000000000000000000", "154000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [6, 18],
    //     workers: [
    //       {
    ...
    //     amount: 18,
    //     prices: ["300000000000000000000", "92000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [11, 27, 32],
    //     workers: [
    //       {
    ...
    //     amount: 33,
    //     prices: ["240000000000000000000", "72000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [1, 15, 26, 34],
    //     workers: [
    //       {
    ...
    //     amount: 18,
    //     prices: ["440000000000000000000", "132000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [8, 22],
    //     workers: [
    //       {
    ...
    //     amount: 18,
    //     prices: ["520000000000000000000", "168000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [13, 25, 31],
    //     workers: [
    //       {
    ...
    //     amount: 30,
    //     prices: ["460000000000000000000", "147000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [10, 19],
    //     workers: [
    //       {
    ...
    //     amount: 2,
    //     prices: ["553000000000000000000", "173000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [],
    //     workers: [],
    //   },
    ...
    //   amount: 50,
    //   prices: ["517000000000000000000", "162000000000000000000000"],
    //   tokens: [WGHO, BONSAI],
    //   agentIds: [7, 23],
    //   workers: [
    //     {
    ...
    //   amount: 40,
    //   prices: ["160000000000000000000", "138000000000000000000000"],
    //   tokens: [WGHO, BONSAI],
    //   agentIds: [9, 28, 35],
    //   workers: [
    //     {
    ...
    //   amount: 10,
    //   prices: ["463000000000000000000", "145000000000000000000000"],
    //   tokens: [WGHO, BONSAI],
    //   agentIds: [3, 14, 27],
    //   workers: [
    //     {
    ...
    //   amount: 21,
    //   prices: ["573000000000000000000", "178000000000000000000000"],
    //   tokens: [WGHO, BONSAI],
    //   agentIds: [6, 12, 30, 32],
    //   workers: [
    //     {
    ...
    //     amount: 33,
    //     prices: ["300000000000000000000", "99000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [2, 11, 24],
    //     workers: [
    //       {
    ...
    //     amount: 30,
    //     prices: ["380000000000000000000", "119000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [5, 17],
    //     workers: [
    //       {
    ...
    //     amount: 30,
    //     prices: ["415000000000000000000", "126000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [8, 22, 29, 34],
    //     workers: [
    //       {
    ...
    //     amount: 42,
    //     prices: ["270000000000000000000", "87000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [1, 16],
    //     workers: [
    //       {
    ...
    //     amount: 2,
    //     prices: ["275000000000000000000", "82000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [],
    //     workers: [],
    //   },
    ...
    //   amount: 40,
    //   prices: ["470000000000000000000", "140000000000000000000000"],
    //   tokens: [WGHO, BONSAI],
    //   agentIds: [4, 19, 31],
    //   workers: [
    //     {
    ...
    //   amount: 26,
    //   prices: ["313000000000000000000", "110000000000000000000000"],
    //   tokens: [WGHO, BONSAI],
    //   agentIds: [7, 20, 28, 35],
    //   workers: [
    //     {
    ...
    //   amount: 15,
    //   prices: ["300000000000000000000", "98000000000000000000000"],
    //   tokens: [WGHO, BONSAI],
    //   agentIds: [3, 14],
    //   workers: [
    //     {
    ...
    //     amount: 31,
    //     prices: ["509000000000000000000", "155000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [6, 12, 27, 33],
    //     workers: [
    //       {
    ...
    //     amount: 100,
    //     prices: ["416000000000000000000", "134000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [9, 18, 25],
    //     workers: [
    //       {
    ...
    //     amount: 2,
    //     prices: ["312000000000000000000", "102000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [],
    //     workers: [],
    //   },
    ...
    //     amount: 20,
    //     prices: ["268000000000000000000", "86000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [2, 13, 30],
    //     workers: [
    //       {
    ...
    //     amount: 13,
    //     prices: ["310000000000000000000", "96000000000000000000000"],
    //     tokens: [WGHO, BONSAI],
    //     agentIds: [5, 17, 29, 34],
    //     workers: [
    //       {
    ...
    [
      ...
      //   amount: 2,
      //   prices: ["364000000000000000000", "118000000000000000000000"],
      //   tokens: [WGHO, BONSAI],
      //   agentIds: [],
      //   workers: [],
      // },
      ...
      // },
      {
        ...
        amount: 10,
        prices: ["170000000000000000000", "143000000000000000000000"],
        tokens: [WGHO, BONSAI],
        agentIds: [4, 19],
        workers: [
          {
      ...
      },
      {
        ...
        amount: 10,
        prices: ["517000000000000000000", "143000000000000000000000"],
        tokens: [WGHO, BONSAI],
        agentIds: [6, 15, 22],
        workers: [
          {
  ...
  if (details.length != artists.length || artists.length != drops.length) {
    console.log(
      "invalid lengths",
      artists.length,
      drops.length,
  ...
  for (let i = 0; i < details.length; i++) {
    ...
    for (let j = 0; j < details[i].length; j++) {
      console.log(
        "now doing collection and drop ",
        j,
        dropId == 18 && j == 0 ? dropId : j == 0 ? 0 : dropId
      );

      const tx = await cmContract.create(
        {
          ...
          remixId: 0,
          remixable: true,
          forArtist: "0x0000000000000000000000000000000000000000",
        },
        details[i][j].workers,
        drops[i],
        dropId == 18 && j == 0 ? dropId : j == 0 ? 0 : dropId
